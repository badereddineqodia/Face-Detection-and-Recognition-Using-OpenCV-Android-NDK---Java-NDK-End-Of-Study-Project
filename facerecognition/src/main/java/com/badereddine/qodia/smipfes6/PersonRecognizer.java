...
public class PersonRecognizer {
    ...
    PersonRecognizer(String path) {
        ...
        //faceRecognizer = com.googlecode.javacv.cpp.opencv_contrib.createEigenFaceRecognizer(15,4000);
    ...
    public boolean train() {//la fonction qui permet de cree le modele dans la base de donne
                            // et de permet de transformer les images a un modele
